          ...
          <section className="description__page__global__container">
            <div className="description__page__container">
              ...
              <div>
                {rating > 4 && (
                  <>
                    Rating: <span className="desc__ratingGreat">{rating}</span>
                  </>
                )}
                {rating <= 4 && rating >= 3 && (
                  <>
                    Rating: <span className="desc__ratingMedium">{rating}</span>
                  </>
                )}
                {rating <= 2.9 && (
                  <>
                    Rating: <span className="desc__ratingBad">{rating}</span>
                  </>
                )}
              </div>
            </div>
