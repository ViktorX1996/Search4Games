    ...
    <div className="description__main__div">
      ...
      <section className="description__page__global__container">
        <div className="description__page__container">
          <div className="description__page__container__title">
            <b>TitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitle</b>
          </div>
          <div>5.22</div>
        </div>
        ...
        <Carousel>
          ...
          <CarouselItem>
            <img
              src="https://media.rawg.io/media/screenshots/fbe/fbe1e38e1b21d64c3660a5c01a2f28d7.jpg"
              alt="First slide"
            />
          </CarouselItem>
          <CarouselItem>
      ...
      <section className="about__section">
        ...
        <span>
          ...
          voluptatum maxime ipsa iusto facilis! Doloremque ex dignissimos vero
          magnam qui fugiat cumque maxime rem eligendi soluta ratione, dicta,
          fugit consectetur laborum modi saepe placeat eveniet quaerat molestias
          magni iure quam dolorem deserunt. Deserunt ipsam voluptatibus illo
          odio temporibus itaque eaque.
        </span>
        <b>
          Website <br />
